...
class Ui_dialog_configuracioes(object):
    def setupUi(self, dialog_configuracioes):
        ...
        dialog_configuracioes.resize(551, 193)
        self.groupBox_2 = QGroupBox(dialog_configuracioes)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(10, 10, 531, 141))
        ...
        self.btn_concertar_configuracoes.setGeometry(QRect(300, 160, 75, 23))
        ...
        self.btn_confirmar_configuracoes.setGeometry(QRect(400, 160, 75, 23))
