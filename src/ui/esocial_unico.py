...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_executa_rpa.setGeometry(QRect(780, 180, 171, 21))
        ...
        self.btn_relacionar_rubricas.setGeometry(QRect(780, 150, 171, 21))
        ...
        self.btn_relaciona_empresas_dominio.setGeometry(QRect(780, 120, 171, 21))
        self.btn_excluir = QPushButton(self.centralwidget)
        self.btn_excluir.setObjectName(u"btn_excluir")
        self.btn_excluir.setGeometry(QRect(780, 210, 171, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_obtem_dados_esocial.setText(QCoreApplication.translate("MainWindow", u"Obter dados do e-Social", None))
